...
// 6. I have made these scripts, so there might be errors or grammatical mistakes, if you run into any please let me know
...
// 3. Make sure your image folder with a corresponding results folder is ready
// 4. Open FIJI
// 5. On the top bar select 'Plugins' -> 'Macros' -> 'Run' 
// 6. Find and select your saved script
// 7. Run!
